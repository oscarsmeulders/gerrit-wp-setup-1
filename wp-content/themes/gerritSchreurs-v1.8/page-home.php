...
<body id="home" <?php body_class('balk'); ?> >
	<?php if ( have_posts() ) : ?>
		...
		<main class="cd-main-content">
			...
			<div class="panel left">
				<a href="<?php echo get_the_permalink(); ?>">
					<div class="slideshow">
						<?php //<div class="one" data-cycle-fx="scrollHorz" data-cycle-progressive="#images-one" data-cycle-slides="> div.slide"> ?>	
						<div class="one"
				...
				<?php echo '<a href="'. get_the_permalink() .'"><div class="button"><div>'. __( 'Photography', 'gs_lang' ) .'</div></div></a>'; ?>
			</div>
			<?php 
				wp_reset_postdata();
				endif;
			...
			<?php
			$photoOverviewPage = get_field( 'film_overview', 'option' );
			if( $photoOverviewPage ) :
				$post = $photoOverviewPage;	// override $post
				setup_postdata( $post );
			?>
			<div class="panel right">
				...
				<?php echo '<a href="'. get_the_permalink() .'"><div class="button"><div>'. __( 'Film', 'gs_lang' ) .'</div></div></a>'; ?>
			</div>
			<?php 
				wp_reset_postdata();
				endif;
